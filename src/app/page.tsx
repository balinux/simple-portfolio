        ...
        <div className="lg:grid grid-cols-3 gap-4 w-full">
          ...
          <div className=" flex items-center justify-center p-4">
            <div className="relative ">
              ...
              {/* Main card */}
              <Card className="relative w-full max-w-4xl rounded-[2rem] border-2 border-zinc-700 bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900 from-zinc-100 to-zinc-100 p-8 overflow-hidden h-[500px]">
                <div className="grid gap-6">
                  <div className=" overflow-hidden rounded-lg">
                    <Image
                      className=" rounded-lg cursor-pointer overflow-hidden transition transform hover:scale-105"
                      src="/udayana-mobile.png"
                      alt="Vercel logomark"
                      width={900}
                      height={200}
                    />
                  ...
                  <Link
                    href="https://apps.apple.com/us/app/udayana-mobile/id1496936074"
