      ...
      {project.map((project, index) => (
        <div key={index} className=" flex items-center justify-center p-4">
          <div className="relative ">
            ...
            {/* Main card */}
            {/* Main card */}
            <Card className="relative w-full max-w-4xl rounded-[2rem] border-2 border-zinc-700 bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900 from-zinc-100 to-zinc-100 p-8 overflow-hidden flex flex-col">
